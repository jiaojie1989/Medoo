...
class Medoo
{
    ...
    public function __construct($options = null)
    {
        ...
        try {
            $this->pdo = new PDO(
                    $dsn, isset($options['username']) ? $options['username'] : null, isset($options['password']) ? $options['password'] : null, $this->option
            );
    ...
    protected function generate($query, $map)
    {
        ...
        $query = preg_replace(
                '/"([a-zA-Z0-9_]+)"/i', isset($identifier[$this->type]) ? $identifier[$this->type] : '"$1"', $query
        );
    ...
    {
        return $this->table_quote . $this->prefix . $table . $this->table_quote;
    }
